                    ...
                    <td style={{ padding: '0.875rem 0.75rem' }}>
                      {!u.isAdmin && (
                        <div style={{ display: 'flex', gap: 6, flexWrap: 'wrap' }}>
                          ...
                          <button onClick={() => { if (window.confirm(`Extend trial 30 days for ${u.email}?`)) extendTrial(u.id, 30) }} style={{ ...ghostBtn, color: '#c4b5fd', borderColor: 'rgba(167,139,250,0.3)' }}>+30d Trial</button>
                          {!u.blocked
